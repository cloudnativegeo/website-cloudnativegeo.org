---
date: 2026-04-21T01:00:38-04:00
title: "CNG Editorial Board Spotlight – Q&A: Julia Wagemann"
tags: [ ""
]
...
<img src="/img/editorial-board/julia-wagemann.png" alt="Julia Wagemann" style="width: 200px; height: auto; float: right; margin: 0 0 20px 20px;">
...
For the last year, I had the pleasure of contributing to the [EOPF Toolkit project](https://github.com/eopf-toolkit), part of ESA's initiative to migrate the Sentinel data archive from the legacy SAFE format to Zarr. Working closely with the Sentinel data user community showed me how transformative this shift can be, not just in terms of performance and scalability, but in opening up Earth observation data to a much broader range of workflows and users.
