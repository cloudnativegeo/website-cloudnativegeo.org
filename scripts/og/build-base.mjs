...
const OUT = path.join(REPO, "assets", "og", "base.png");
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <g transform="translate(${PAD_X}, ${LOGO_Y}) scale(${LOGO_H / LOGO_VB_H})">
    <path d="${WORDMARK_D}" fill="${SOFT_WHITE}"/>
  </g>
</svg>`;
...
console.log(`wrote ${OUT} (logo ${LOGO_W.toFixed(1)}×${LOGO_H} at ${PAD_X},${LOGO_Y})`);
